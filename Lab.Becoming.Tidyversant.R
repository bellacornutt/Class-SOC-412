...
library(tidyverse)
load(url("https://github.com/AaronGullickson/stat_
         data/raw/main/output/earnings.RData"))
earnings
load("data/earnings.RData")

# Tidy it up -----------------------------------------

# group wages into five dollar groups na dcalculate percent of 
...
# calculate mean wages by gender and then reshapedata wide so male and female 
